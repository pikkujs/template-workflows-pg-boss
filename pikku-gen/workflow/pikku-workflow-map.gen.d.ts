...
export type WorkflowMap = {
  readonly 'happyRetryWorkflow': WorkflowHandler<HappyRetryWorkflowInput, HappyRetryWorkflowOutput>,
  readonly 'orgOnboardingSimpleWorkflow': WorkflowHandler<OrgOnboardingSimpleWorkflowInput, OrgOnboardingSimpleWorkflowOutput>,
  readonly 'sequentialInviteSimpleWorkflow': WorkflowHandler<SequentialInviteSimpleWorkflowInput, SequentialInviteSimpleWorkflowOutput>,
  readonly 'unhappyRetryWorkflow': WorkflowHandler<UnhappyRetryWorkflowInput, UnhappyRetryWorkflowOutput>,
  readonly 'onboardingWorkflow': WorkflowHandler<OnboardingWorkflowInput, OnboardingWorkflowOutput>,
};
