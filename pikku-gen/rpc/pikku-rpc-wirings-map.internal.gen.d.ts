...
export type RPCMap = {
  ...
  readonly 'createOrg': RPCHandler<CreateOrgInput, CreateOrgOutput>,
  readonly 'createOwner': RPCHandler<CreateOwnerInput, CreateOwnerOutput>,
  readonly 'inviteMember': RPCHandler<InviteMemberInput, InviteMemberOutput>,
  readonly 'sendWelcomeEmail': RPCHandler<SendWelcomeEmailInput, SendWelcomeEmailOutput>,
  readonly 'triggerOrgOnboardingSimple': RPCHandler<TriggerOrgOnboardingSimpleInput, TriggerOrgOnboardingSimpleOutput>,
  readonly 'triggerSequentialInviteSimple': RPCHandler<TriggerSequentialInviteSimpleInput, TriggerSequentialInviteSimpleOutput>,
